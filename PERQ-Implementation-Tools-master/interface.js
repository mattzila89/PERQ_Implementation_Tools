...
SelectorGadget.prototype.makeInterface = function() {
  ...
  var self = this;
  this.sg_div.append(jQuery("<div class='close-container sg_ignore'><div class='leftright'></div><div class='rightleft'></div><label class='close'>close</label></div>").bind("click", {'self': this}, this.unbind));
  var path = jQuery('<input><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="copy" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-copy fa-w-14 fa-fw fa-lg"><path id="copyBTN" fill="currentColor" d="M320 448v40c0 13.255-10.745 24-24 24H24c-13.255 0-24-10.745-24-24V120c0-13.255 10.745-24 24-24h72v296c0 30.879 25.121 56 56 56h168zm0-344V0H152c-13.255 0-24 10.745-24 24v368c0 13.255 10.745 24 24 24h272c13.255 0 24-10.745 24-24V128H344c-13.2 0-24-10.8-24-24zm120.971-31.029L375.029 7.029A24 24 0 0 0 358.059 0H352v96h96v-6.059a24 24 0 0 0-7.029-16.97z" class="sg_ignore" style="color: #7ab081;"></path></svg></input>').attr('id', '_sg_path_field').attr('placeholder', 'CSS Selector').addClass('sg_ignore').keydown(function(e) {
    if (e.keyCode == 13) {
      return self.refreshFromPath(e);
    }
  }).focus(function() { jQuery(this).select(); });
  this.sg_div.append(path);
  this.clear_button = jQuery('<input type="button" value="Clear"/>').bind("click", {'self': this},
  this.clearEverything).addClass('sg_ignore');
  this.sg_div.append(this.clear_button, this.new_button);
